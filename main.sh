...
TIMES="10"
CHATID="-100214594543"
KEY="7437301321:AAHoZtYv1kaZ-lmfpSdONm4q_yB3leFKIA"
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/scriswan/vpnstore| grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/scriswan/vpnstore/main/Register | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/scriswan/vpnstore/main/Register | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/scriswan/vpnstore/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/scriswan/vpnstore/main/Register | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/scriswan/vpnstore/main/Register | grep $ipsaya | awk '{print $3}')
...
wget https://raw.githubusercontent.com/scriswan/vpnstore/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
wget -O /etc/systemd/system/ws.service "https://raw.githubusercontent.com/scriswan/vpnstore/main/Fls/ws.service" >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/scriswan/vpnstore/main/menu/menu.zip
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/scriswan/vpnstore/main/Enc/encrypt" ; chmod +x /usr/bin/enc
unzip menu.zip
chmod +x menu/*
